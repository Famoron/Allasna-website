$(function () {
    ...
    $(window).on("scroll", function (event) {
        ...
        if (scroll < 20) {
            ...
            $(".navbar .navbar-brand img").attr("src", "assets/img/logo-light.png");
        } else {
    ...
    if (document.getElementById("particles-1"))
        particlesJS("particles-1", {
            particles: {
                ...
                shape: { type: "circle", stroke: { width: 0, color: "#fff" }, polygon: { nb_sides: 5 }, image: { src: "img/github.svg", width: 33, height: 33 } },
                opacity: { value: 0.15, random: !0, anim: { enable: !0, speed: 0.2, opacity_min: 0.15, sync: !1 } },
